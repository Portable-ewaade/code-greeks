...
export default async function handler(req, res) {
  ...
  if (body.course === 'Fullstack Web') {
    tools =
      'HTML, CSS, JavaScript, ReactJS, NextJS, Bootstrap, Tailwind, NodeJS, MongoDB, Git, Postman';
    ...
    tools = 'HTML, CSS, JavaScript, ReactJS, Tailwind, NodeJS, MongoDB, Git, Postman';
    manualUrl = 'https://shorturl.at/adCL3';
  ...
  try {
    ...
    const reply_to = 'app@globaltriumph.ng';
    const send_from = 'app@globaltriumph.ng';
