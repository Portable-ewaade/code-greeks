...
const index = () => {
  return (
    ...
    >
      ...
      <div className="text-white mt-5 mt-md-0 mb-5 text-center">
        <h2 className="fw-bold mt-md-5">Student Reviews</h2>
        <h6 className=" fw-bold mt-5 pt-md-5">
          Here are reviews gotten from Code Geeks 9ja students
        </h6>
        <h6 className=" fw-bold mb-5 mt-4">4.5 out of 5 | 5,281 reviews</h6>
      </div>

      <div  style={{ background: "#0F0113" }}>  
