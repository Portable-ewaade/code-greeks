  ...
  return (
    <section className="pb-5 bx-container p-0">
      <Row className="p-0 align-items-center">
        <Col md={8} className=" mt-5 animate__animated animate__slideInRight m3 m-md-0">
        ...
        <Col md={4} className=" mt-md-5 animate__animated animate__slideInRight m-md-0 p-0">
          <div className="card-border text-black rounded-4 w-100 p-0">
            ...
            <div className="card-body text-white">
              <p className="card-text fs-small p-3">
                ...
                development using HTML, CSS, Javascript, ReactJS, Styling Components, NodeJS +
                Express, MongoDB from absolute zero to hero
              </p>
