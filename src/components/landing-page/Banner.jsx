  ...
  return (
    <section className="pb-5 bx-container p-0">
      <Row className="p-0 align-items-center py-3 py-md-5">
        <Col md={8} className=" mt-5 animate__animated animate__zoomIn m3 m-md-0">
          <div className="mt-0 mt-md-5" style={{ width: '100%', background: 'transparent' }}>
            ...
            <h2 className="text-white fw-bold mb-4 mt-3">Become The Next Code Geek In 9ja!</h2>
        ...
        <Col md={4} className=" mt-md-5 animate__animated animate__zoomIn m-md-0 px-3 px-md-2">
          <div className="dark-shadow-lg card-border text-black rounded-4 w-100 px-0 pb-4">
            <div
              className="p-3 border-0 rounded-top-4 text-center"
              style={{ background: '#E08CF9' }}
            >
              <h6 className="fw-bold ">Web Frontend Development</h6>
              <p className="fs-normal">Course start in </p>
              <h5>A timer here</h5>
            </div>
            <div className="card-body text-white">
              <p className="card-text text-white fs-small p-3">
                The development journey will take you through mastering fullstack web application
                development using HTML, CSS, Javascript, ReactJS, NextJS, Styling Components
                ...
                <Row>
                  <Col md={4} xs={4} className="mb-3">
                    <div className="round-bg">
                      <img src="/assets/html.png" alt="Code Geeks 9ja" className="p-3 img-fluid" />
                    </div>
                  </Col>
                  <Col md={4} xs={4} className="mb-3">
                    <div className="round-bg">
                      <img src="/assets/css.png" alt="Code Geeks 9ja" className="p-3 img-fluid" />
                    </div>
                  </Col>
                  <Col md={4} xs={4} className="mb-3">
                    <div className="round-bg">
                  ...
                  <Col md={4} xs={4} className="mb-3">
                    <div className="round-bg">
                      <img src="/assets/node.png" alt="Code Geeks 9ja" className="mt-1 img-fluid" />
                    </div>
                  </Col>
                  <Col md={4} xs={4} className="mb-3">
                    <div className="round-bg">
