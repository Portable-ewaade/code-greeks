          ...
          <Row className=''>
            ...
            <Col md={6} className=" text-white p-sm-5 my-5 mb-5">
              ...
              <p className="fs-small footer-text-color">
                With us, you get the ultimate coding training and proper mentorship
                <br className="d-md-block d-none" /> and guidance from some of the best and
        ...
        <Row className="mt-5 mt-md-0 pb-5 px-md-4 ">
          ...
          <Col md={4} className="mb-3 text-center px-4 px-md-2">
            <div className="card border border-2 bg-transparent h-100 p-3 text-white">
              ...
              <p className="fs-small footer-text-color">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas beatae vitae inventore
                voluptates ipsum, odio optio natus, maiores cupiditate ducimus error, accusantium
                ipsa at assumenda laboriosam incidunt omnis ullam numquam debitis quos.
              </p>
